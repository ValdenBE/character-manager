...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/showdown/dist/showdown.js":[function(require,module,exports) {
var define;
...
(function (window) {
                        ...
                        return __generator(this, function (_a) {
                          switch (_a.label) {
                            case 0:
                              return [4
                              /*yield*/
                              , axios["delete"](api + '/characters/' + element.id)];
                  ...
                  btnSubmit.addEventListener("click", function () {
                    ...
                    if (checker == false) {
                      ...
                      if (inputName_1.value == "" || inputShortDesc_1.value == "" || inputFullDesc_1.value == "" || inputImg_1.value == "") {
                        var _openForm = function _openForm() {
                          document.getElementById("myForm").style.display = "block";
                        };
  ...
  document.getElementsByClassName('form-popup')[0].appendChild(deleteBtn); //Create Button
  ...
  btnSubmit.addEventListener("click", function () {
    ...
    if (checker == true) {
            ...
            switch (_a.label) {
              case 0:
                ...
                , axios.post(api + '/characters', {
                  name: inputName_2.value,
                  shortDescription: inputShortDesc_2.value,
                  description: inputFullDesc_2.value,
                  image: inputImg_2.value
                })];
      ...
      var inputName_2 = document.getElementById("name");
      var inputShortDesc_2 = document.getElementById("shortDesc");
      var inputFullDesc_2 = document.getElementById("fulDesc");
      var inputImg_2 = document.getElementById("pict");

      if (inputName_2.value == "" || inputShortDesc_2.value == "" || inputFullDesc_2.value == "" || inputImg_2.value == "") {
...
},{"axios":"node_modules/axios/index.js","showdown":"node_modules/showdown/dist/showdown.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
>>>>>>> 3b614f134ca9346de1ea4edce58fa616bba9b152
